...
def main():
    global fenetreJeu2,answer, result, Indication,boutonSuivant, Morse, BonneRep, label3, labelVide, MauvaiseRep, compteurMot, goodanswer, Try, zoneRep, labelMot, labelVide2, valeurPrenom, number, prenom, EntreePrenom, EntreeNbr, label1, label2
