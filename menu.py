...
##fonction ouverture
def batjeu1():
    #Ouvrir le programme "jeu_calcul_mental" en laissant la main au programme principale.
    import jeu_calcul_mental
    jeu_calcul_mental.main()

def batjeu2():
    #Ouvrir le programme "jeu du morse" en laissant la main au programme principale.
    import JeuMorse
    JeuMorse.main()
    
def batjeu3():
    #Ouvrir le programme "jeu des capitales" en laissant la main au programme principale.
    import choix
    choix.main()

def batjeu4():
    #Ouvrir le programme "jeu de traduction Ang/Fr" en laissant la main au programme principale.
    import traducteur
    traducteur.main()
