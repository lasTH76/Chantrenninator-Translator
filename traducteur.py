...
def main():
        global fenetreJeu, nbMot, score, nbrEssai, ReponseJoueur, actAn, actFr, labelMot, labelIndic, EntreeRep, BoutonAccRep, compteurMot, label3, labelVide2, valueName, prenom, label1, label2, bouton1, boutonFr, boutonAn, reponse
        ...
        listfF = [line.split('\n') for line in fF.readlines()]              ##je lui demande de creer une liste a chaque fois qu'il y a un saut de ligne dans le fichier txt
        ...
        def Game():
                global nbMot, actAn, actFr, labelMot, EntreeRep, nbMot, valueName, score, compteurMot, label2, label3, reponse
                def Accept(event):      #Cette fonction sert a verifier la reponse du joueur et d'agir en consequence
                        global ReponseJoueur, score, nbrEssai, labelIndic, labelVide2, reponse
